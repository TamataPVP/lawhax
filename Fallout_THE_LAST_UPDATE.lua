...
CreateThread(function()
    ...
    function FM.FreeCam:Spawner(where, heading, type)
        ...
        FM.Painter:DrawText("~w~[~y~Chakal Menu~w~] " .. (name or "?"), 4, false, FM:ScrW() - 360 - 21 - offX, 21, 0.35, 255, 255, 255, 255)
        local sY = 30
        local max_opts = 30
